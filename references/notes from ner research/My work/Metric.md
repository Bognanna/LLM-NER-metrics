...
CDE is the arthmetical average of cosinus distances between the embeddings of gold entities and the embeddings of generated entities. The distance is calculated only for paired entites. If two paired entites have different enitiy types, the distance between them is set to 2. CDE is dependent on the method of pairing the generated and gold entities.
