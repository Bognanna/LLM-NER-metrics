...
26.02.2025
Agenda:
PART I - Przedstawienie stanu pracy
- przedstawienie metryk, z naciskiem na zakresy i optymalne wartości
- przedstawienie pomysłu na benchmark
PART II - Ewentualne pytania z do omówienia, jeżeli czegoś nie poruszyłam
PART III - Dalsze prace - jak rozplanować
- testy: znalazłam pracę, z której wynika, że GPT 3.5 < GPT 4.0
Do omówienia:
2. Co z abstrakcyjnym przypadkiem, gdy encje składają się z nic nieznaczącego zlepku liter i znaków? Czy badać w ogóle taki przypadek? Tradycyjne metryki dałyby po prostu wartość 0.
3. Czy edytować encje w benchmarku, skoro 1 do 1 pochodzą one z zbioru Cadec? Jak finalnie zedytować encje w benchmarku: ujednolicenie zaimków (?), ujednolicenie form czasowników (?), ujednolicenie kolejności słów (?), skrócenie opisowych form episodes of vomiting vs. vomiting episodes (?), zostawiać określenia np. sligtly (?), jakieś standardowe znaki np. and zamiast & (?)
4. Pisząc na jaką formę powinnam się zdecydować (bezosobowa czy też wszędzie I/We)?
...
7. Na ile istotne jest to co programuje a na ile same wyniki i teoria stojąca za metryką? Czy są jakieś standardy, które musi spełniać mój kod (np. korzystanie z klas, pisanie optymalnych fragmentów kodu)?
